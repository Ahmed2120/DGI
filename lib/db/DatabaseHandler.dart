  ...
  Future<Database> initializeDB() async {
    ...
    return openDatabase(
      ...
      onCreate: (database, version) async {
        ...
        batch.execute("CREATE TABLE item(Id INTEGER PRIMARY KEY , Name TEXT NOT NULL, AccountGroupId INTEGER, ItemType INTEGER, HasMark BOOLEAN , HasWidth BOOLEAN , HasHeight BOOLEAN , HasLength BOOLEAN)");
        ...
        batch.execute("CREATE TABLE captureDetails(Id INTEGER PRIMARY KEY AUTOINCREMENT , Name TEXT,Image BLOB NOT NULL,ItemId  INTEGER NOT NULL,AssetLocationId INTEGER NOT NULL,Description TEXT NOT NULL,Quantity INTEGER NOT NULL,FloorId INTEGER,DepartmentId INTEGER,SectionId INTEGER,BrandId INTEGER,DescriptionId INTEGER,SerialNumber TEXT,isUploaded BOOLEAN DEFAULT false,Color TEXT,Width INTEGER,Height INTEGER,Length INTEGER, Code TEXT, AjehzaTamolkNumber TEXT, ServiceDate TEXT, productionAge TEXT, AccumulatedConsumption TEXT, TransRefNumber TEXT, SupplierName TEXT, TransBoardNumber TEXT, transCreationDate TEXT, TransType TEXT, transHiekelNumbe TEXT, TransMamsha TEXT, AssetBookValue TEXT)");
