...
class ItemNewVerification extends StatefulWidget {
  const ItemNewVerification({Key? key}) : super(key: key);

  @override
  State<ItemNewVerification> createState() => _ItemNewVerificationState();
}

class _ItemNewVerificationState extends State<ItemNewVerification> {
