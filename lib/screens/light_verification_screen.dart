...
class _LightVerificationScreenState extends State<LightVerificationScreen> {
  ...
  List<Item> items = [];
  List<Asset> assets = [Asset(id: 1, image: null, isVerified: 0),Asset(id: 1, image: null, isVerified: 0),];
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text('$currentPage/${LightVerificationService.totalPages}'),
                        ],
                      ),
                    ],
                  ),
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      loadPage ? const CircularProgressIndicator() : CustomWidgetBuilder.buildArrow(
                          context,
                          dSize,
      ...
      listings.add(
        CustomWidgetBuilder.lightVerificationTable(
          [
            ...
            paginateAsset[currentPage]![i] == null || paginateAsset[1]![i].image == null
                ? Image.asset(
  ...
  Widget checkbox(int i) {
    return Transform.scale(
      scale: 1.7,
      child: Checkbox(
                value: paginateAsset[currentPage]![i].isVerified == 0 || paginateAsset[currentPage]![i].isVerified == null ? false : true,
                onChanged: (val) {
                  setState(() {});
  ...
  void nextPage() async{
    if(currentPage == lastPage) {
      if (lastPage <
          LightVerificationService.totalPages) {
        lastPage++;
        setState(() => loadPage = true);
        await lightVerificationService
            .downloadAssets(lastPage, sectionId!);
        paginateAsset.addEntries([
          MapEntry(lastPage,
              LightVerificationService.assets)
        ]);
      }
    }
