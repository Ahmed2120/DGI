...
import 'assets_capture_screen.dart';
import 'assets_details.dart';

class ItemNewCapture extends StatefulWidget {
  const ItemNewCapture({Key? key}) : super(key: key);

  @override
  State<ItemNewCapture> createState() => _ItemNewCaptureState();
}

class _ItemNewCaptureState extends State<ItemNewCapture> {
                                        ...
                                        onTap: ()=> Navigator.of(context).push(
                                            MaterialPageRoute(
                                                builder: (context) => AssetsCapture(
                                                  ...
                                                  departmentId: assetLocation.departmentId,
                                                  sectionId: sectionGroups[index].id,
                                                  floorId: assetLocation.floorId,
                                                ))),
                                        child: Container(
